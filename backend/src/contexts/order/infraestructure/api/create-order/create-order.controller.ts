...
import { User } from 'src/contexts/shared/decorators/user.decorator';
import { Token } from 'src/contexts/shared/decorators/token.decorator';
...
export class CreateOrderController {
  ...
  @UseGuards(AuthGuard)
  async run(
    @Body() createOrderHttpDto: CreateOrderHttpDto,
    @User() userId: string,
  ) {
